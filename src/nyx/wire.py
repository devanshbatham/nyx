...
class ModelMetadata(BaseModel):
    name: str = Field(..., description="Model name or alias accepted by the request's model field.", examples=["nyx"], title="Name")
...
class ModelMetadataList(BaseModel):
    models: list[ModelMetadata] = Field(
        ...
        examples=[[{"description": "General-purpose system one model.", "name": "nyx", "release_date": "2026-09-15"}]],
        title="Models",
    )
